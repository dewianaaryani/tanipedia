        ...
        <form method="POST" action="{{route('admin.messages.update', $message->id)}}" enctype="multipart/form-data">
            ...
            <div class="row">   
                ...
                <div class="form-group col-12">
                    ...
                    <input id="email" type="text" class="form-control" name="email" value="{{$message->email}}" autofocus>
                </div>   
                @error('email')
                    <div class="col-6">         
            ...
            <div class="row">   
                ...
                <div class="form-group col-12">
                    ...
                    <input id="message" type="text" class="form-control" name="message" value="{{$message->message}}">
                </div>   
                @error('message')
                    <div class="col-6">         
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
